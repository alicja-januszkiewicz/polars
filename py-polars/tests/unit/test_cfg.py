...
def test_numeric_right_alignment() -> None:
    ...
    df = pl.DataFrame(
        {
            "a": [110000000.1, 22200000.2, 3333000.33333],
            "b": [400000000.0, 5, 600000000.0],
            "c": [70000.0, 800000000.0, 90],
        }
    )
    with pl.Config():
        ...
        assert (
            ...
            "│     f64 ┆     f64 ┆       f64 │\n"
            "╞═════════╪═════════╪═══════════╡\n"
            "│ 1.100e8 ┆ 4.000e8 ┆ 70000.000 │\n"
            "│ 2.220e7 ┆   5.000 ┆   8.000e8 │\n"
            "│ 3.333e6 ┆ 6.000e8 ┆    90.000 │\n"
            "└─────────┴─────────┴───────────┘"
        )
